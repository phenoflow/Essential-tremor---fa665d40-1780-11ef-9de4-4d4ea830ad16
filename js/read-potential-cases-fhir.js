...
(async () => {
  ...
  await fs.writeFile("essential-tremor-potential-cases.csv", "patient-id,dob,codes,last-encounter\n");
  for(let patient in patients) {
    try {
      ...
      await fs.appendFile("essential-tremor-potential-cases.csv", row);
    } catch(error) {
      console.log(error);
    }
  }
